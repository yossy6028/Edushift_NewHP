        ...
        <div className="s-container">
            ...
            <div className="s-faq-list">
                ...
                <details className="s-faq-item">
                    ...
                    <div className="s-faq-a">
                        <span className="s-faq-a-marker">A.</span>
                        制作プランは、ライト ¥19,800、スタンダード ¥39,800、SEO特化 ¥98,000（いずれも税抜・初期費用）。保守運用は月々 ¥980〜 ¥29,800 の3プランです。ライト／スタンダードプランでは制作時の修正は「納品前まで3回」として低価格を実現しています（以降は有償対応）。原稿・画像は指定フォーマット（Excel／Word）で全てご用意いただいた段階で着手します。
                    </div>
                </details>
