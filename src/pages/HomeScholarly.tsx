...
import { YS_LEAD_METRIC, YS_AI_LEAD_METRIC } from '../data/caseStudies';
        ...
        <div className="s-container">
            ...
            <div className="s-service-grid has-pillars">
                ...
                <div className="s-service-card pillar m-hp-featured" data-reveal="right" data-reveal-delay="1">
                    ...
                    <a href="/works/ys-kokugo" className="s-service-case-link">実績: ChatGPT経由流入{YS_AI_LEAD_METRIC.multiplier}・問い合わせ{YS_LEAD_METRIC.multiplier}の事例 →</a>
                </div>
            </div>
        </div>
    </section>
