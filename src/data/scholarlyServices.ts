...
export const SCHOLARLY_SERVICES: Record<string, ServiceContent> = {
    ...
    'ai-consulting': {
        ...
        narrativeParas: [
            ...
            'EduShiftが提案するのは、「先生をスーパーマンにする」ためのAI活用です。事務作業の自動化で生徒と向き合う時間を増やし、AI教材で個別に最適化された指導を実現する。現場に無理なく馴染む、実用的な導入支援を行います。なお、ツールやアプリの受託開発そのものは姉妹サービス「塾DX・ツール開発」で承っています。本サービスは"使いこなす"ための導入・研修に軸足を置いています。',
        ],
        supportItems: [
