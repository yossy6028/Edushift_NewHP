...
export const SCHOLARLY_SERVICES: Record<string, ServiceContent> = {
    ...
    'hp-production': {
        ...
        narrativeParas: [
            ...
            'EduShiftの保守プランは「壊れたら直す」だけじゃありません。ブログ更新・SEO改善・集客レポート——あなたの塾の「Web担当者」として、毎月継続サポートします。保守プランの詳細は /v2 トップページの Pricing セクションをご覧ください。',
        ],
        supportItems: [
        ...
        pricingBlock: {
            ...
            footnote: '公開後の保守・運用プラン（¥980/¥2,980/¥29,800）は、/v2 のトップページでご確認いただけます。',
        },
